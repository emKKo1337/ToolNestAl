...
description: 'Most "merge PDF" tools upload your file to a server first. Here is how the browser-only alternative works, and how to tell which kind of tool you are actually using.'
